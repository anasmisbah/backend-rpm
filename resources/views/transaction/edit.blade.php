    ...
    <div class="col-md-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title">Update Transaction {{$distributor->name}}</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{route('transaction.distributor.update',$transaction->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <div class="input-group date" id="pricing_date" data-target-input="nearest">
                                    <input value="{{$transaction->pricing_date}}" type="text" class="form-control datetimepicker-input" data-target="#pricing_date" name="pricing_date"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <div class="input-group date" id="billing_date" data-target-input="nearest">
                                    <input value="{{$transaction->billing_date}}" type="text" class="form-control datetimepicker-input" data-target="#billing_date" name="billing_date"/>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6 col-lg-6 col-md-6">
                            <input value="{{$transaction->quantity}}" type="number" class="form-control" id="quantity" name="quantity" placeholder="quantity">
                          </div>
                        </div>
                        <div class="form-group row">
                            <label for="total" class="col-sm-2 col-form-label">Total<span class="text-danger">*</span></label>
                            <div class="col-sm-6 col-lg-6 col-md-6">
                                <input value="{{$transaction->total}}" type="number" class="form-control" id="total" name="total" placeholder="total">
                            </div>
                        </div>
                      </div>
